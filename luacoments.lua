...
function Library:create(options)
	...
	creditsTab:credit{Name = "xyn", Description = "private", Discord = "priv", V3rmillion = "priv"}
		creditsTab:credit{Name = "xyn", Description = "private", Discord = "priv", V3rmillion = "priv"}
	creditsTab:credit{Name = "Repository", Description = "UI Library Repository", Github="lol no"}
